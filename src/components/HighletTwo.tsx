...
// function HighletTwo() {
//   return (
//     <div className="flex flex-col md:flex-row gap-4 h-auto md:h-[80vh] p-4 px-0 ">
//       {/* Left section */}
//       <div className="w-full md:w-[55vw] flex flex-col gap-4 shadow-md overflow-hidden">
