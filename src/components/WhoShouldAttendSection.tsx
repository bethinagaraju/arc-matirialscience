  ...
  const attendees = [
    {
      title: "Faculty & Professors",
      description:
        "Educators and academic leaders guiding future research directions, shaping curriculum development, and advancing innovation in AI, ML, and Robotics.",
      icon: GraduationCap,
    },
    {
      title: "PhD, Master’s & Undergraduate Students",
      description:
        "Students building academic expertise, presenting research, publishing papers, and engaging with the global scientific community.",
      icon: School,
    },
    {
      title: "Robotics Engineers",
      description:
        "Professionals designing autonomous systems, robotic platforms, simulations, and intelligent infrastructure.",
      icon: Bot,
    },
    {
      title: "AI Researchers & Data Scientists",
      description:
        "Experts working on neural networks, LLMs, reinforcement learning, generative AI, and applied intelligent systems.",
      icon: BrainCircuit,
    },
    {
      title: "CTOs, CIOs & Industry Leaders",
      description:
        "Decision-makers defining technology strategy, evaluating AI adoption, and driving enterprise-scale innovation.",
      icon: Briefcase,
    },
    {
      title: "Industry Practitioners & Innovators",
      description:
        "Innovators applying AI and robotics to real-world industrial, societal, and global challenges.",
      icon: Rocket,
    },
  ];
          ...
          {attendees.map((item, index) => {
            ...
            return (
              <div key={index} className="relative pl-10">
                ...
                {/* Vertical Accent */}
                {/* <span className="absolute left-0 top-2 h-full w-[2px] bg-[#C9AB63]/60" /> */}
                ...
                <div className="flex items-start gap-5">
                  ...
                  {/* Content */}
                  <div>
                    <h3 className="text-xl font-semibold text-[#1C1F23] mb-1">
                      {item.title}
                    </h3>
