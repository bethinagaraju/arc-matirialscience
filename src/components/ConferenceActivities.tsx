  ...
  const activities = [
    {
      ...
      icon: Brain,
      description:
        "Peer-reviewed oral presentations covering theoretical advances, applied research, and emerging innovations in Artificial Intelligence, Machine Learning, and Robotics."
    },
    {
      title: "Poster Sessions",
      icon: Presentation,
      description:
        "Dedicated poster sessions showcasing ongoing research, early-stage studies, and practical implementations, with interactive discussions between authors and attendees."
    },
    {
      title: "Workshops",
      icon: Users,
      description:
        "Interactive sessions focused on emerging tools, methodologies, and real-world applications, led by academic and industry professionals."
    },
    {
      title: "Tutorials",
      icon: BookOpen,
      description:
        "Educational sessions designed to provide structured overviews of core and advanced topics for participants from diverse technical backgrounds."
    },
    {
      title: "Panel Discussions",
      icon: MessageSquare,
      description:
        "Expert-led discussions addressing current challenges, future directions, and interdisciplinary perspectives in intelligent systems and robotics."
    },
    {
      title: "Networking & Social Activities",
      icon: Handshake,
      description:
        "Opportunities for informal interaction, collaboration, and professional networking among researchers, students, and industry participants."
    }
  ];
    ...
    <section className="py-20 px-6 bg-white">
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="space-y-8">
          {activities.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="flex gap-5 pb-6 border-b border-[#E5E7EB] last:border-none"
              >
                {/* Icon */}
                <div className="mt-1">
                ...
                {/* Content */}
                <div>
                  <h3 className="text-lg font-semibold text-[#1F2327] mb-1">
                    {item.title}
                  </h3>
                  <p className="text-sm text-[#6B6F74] leading-relaxed">
                    {item.description}
                  </p>
                </div>
              </div>
        ...
        <div className="flex gap-4 pt-8 border-t border-[#E5E7EB]">
          <Info className="w-5 h-5 text-[#C9AB63] mt-1 shrink-0" />
          <p className="text-sm text-[#6B6F74] leading-relaxed max-w-3xl">
            Session topics, formats, and schedules are subject to refinement as
            submissions are reviewed and the scientific program is finalized.
          </p>
        </div>
