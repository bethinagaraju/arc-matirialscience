...
function VenueComponent() {
  return (
    <section className="font-sans text-[#1F2327]">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        {/* Label */}
        <span className="inline-block text-xs font-semibold tracking-wide uppercase text-[#C9AB63] mb-3">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-6 mb-10">
          ...
          <div className="flex items-center gap-3">
            <MapPin className="w-5 h-5 text-[#C9AB63]" />
            <span className="text-sm text-[#6B6F74]">
              Rome, Italy
            </span>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 border border-[#E5E7EB] text-sm font-semibold hover:border-[#C9AB63] transition"
            >
              <Navigation className="w-4 h-4 text-[#C9AB63]" />
              Get Directions
            </a>

            <a
              href="https://www.ihg.com/crowneplaza/hotels/gb/en/rome/romsp/hoteldetail"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 border border-[#E5E7EB] text-sm font-semibold hover:border-[#C9AB63] transition"
            >
              <ExternalLink className="w-4 h-4 text-[#C9AB63]" />
              Visit Website
            </a>
      ...
      {/* =======================
          MAP SECTION
      ======================= */}
      <div className="w-full h-[300px] border-t border-[#E5E7EB] relative">
        ...
        {/* Map Label */}
        <div className="absolute top-4 right-4 bg-white px-3 py-1.5 border border-[#E5E7EB] text-xs font-semibold flex items-center gap-2">
          <MapPin className="w-3 h-3 text-[#C9AB63]" />
          Live Location
        </div>
