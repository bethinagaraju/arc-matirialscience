...
const TopNavbar = ({ menuOpen, setMenuOpen }: { menuOpen: boolean; setMenuOpen: (open: boolean) => void }) => {
      ...
      <div className="container mx-auto px-4 h-[90px] sm:h-[120px] flex items-center justify-between">
        ...
        <div className="flex h-full items-center divide-x divide-gray-200">
          ...
          <div className="h-full flex items-center">
            <Link to="/" title="Go to PharmaTech 2026 Home Page" aria-label="PharmaTech 2026 Home Page">
              <img
                src="/aimllogo.jpg"
          ...
          <div className="pl-4 sm:pl-6 flex-col space-y-1 sm:space-y-2 text-[11px] sm:text-sm text-gray-800 min-w-[180px] sm:min-w-[200px] flex">
            <div className="flex items-center space-x-2 sm:space-x-3">
              <Calendar className="text-[#c9ab63]" size={16} />
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              <MapPin className="text-[#c9ab63]" size={16} />
  ...
  <div className="flex items-center justify-center space-x-1">
    ...
    <Globe className="text-[#c9ab63]" size={16} />
  </div>
  <span className="font-semibold tracking-tight sm:text-sm leading-snug text-[#c9ab63]">
        ...
        <div className="hidden md:flex items-center gap-4 ml-12">
          <Link to="/register" title="Register for PharmaTech 2026 Conference" aria-label="Register for PharmaTech 2026 Conference">
            <button 
              ...
              className="bg-[#C9AB63] w-[120px] text-white font-bold py-2 hover:bg-[#C9AB63]/80 transition-colors duration-300"
