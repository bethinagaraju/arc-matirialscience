...
//             Discover the comprehensive program of PharmaTech 2026 featuring cutting-edge research and innovative sessions.
//           </p>
//         </div>
//       </div>
...
//             PharmaTech 2026 features a dynamic blend of formats designed to maximize knowledge transfer and networking in AI & Robotics.
//           </p>
//         </div>
...
const tracksData: Track[] = [
  {
    id: 1,
    title: '1️⃣ Core Robotics & AI Foundations',
    description: 'This track focuses on machine learning and AI techniques for autonomous robots, including perception, decision-making, multi-robot coordination, and neuromorphic computing.',
    subtopicsLabel: 'Subtopics:',
    subtopics: [
      'Advances in Machine Learning for Robotics',
      'Deep Learning Architectures for Intelligent Robotics Systems',
  ...
  },
  {
    id: 2,
    title: '2️⃣ Industrial & Service Robotics',
    description: 'This track covers robotics applications in industries, smart manufacturing, logistics, healthcare, agriculture, construction, and maintenance.',
    subtopicsLabel: 'Subtopics:',
    subtopics: [
      'Smart Manufacturing & Industry 4.0',
      'Collaborative Robots (Cobots)',
  ...
  },
  {
    id: 3,
    title: '3️⃣ Aerospace, Space & Defense Robotics',
    description: 'Focus on autonomous systems in space, aerospace, defense, and drone technologies for exploration, maintenance, and operations.',
    subtopicsLabel: 'Subtopics:',
    subtopics: [
      'Autonomous Spacecraft & Planetary Rovers',
      'AI in Satellite Operations & Maintenance',
  ...
  },
  {
    id: 4,
    title: '4️⃣ AI Research & Applications',
    description: 'This track emphasizes AI research in perception, decision-making, generative models, explainable AI, ethics, and next-generation computing.',
    subtopicsLabel: 'Subtopics:',
    subtopics: [
      'Natural Language Processing & Human Communication',
      'Computer Vision & Object Recognition',
  ...
  },
  {
    id: 5,
    title: '5️⃣ Intelligent Systems & Integration',
    description: 'Track on integrating AI into cyber-physical systems, edge intelligence, sensor fusion, digital twins, intelligent control, and predictive analytics.',
    subtopicsLabel: 'Subtopics:',
    subtopics: [
      'Cyber-Physical Systems',
      'Edge AI & Embedded Intelligence',
  ...
  },
  {
    id: 6,
    title: '6️⃣ Sustainability & Societal Impact',
    description: 'Focus on robotics and AI solutions for renewable energy, disaster response, climate modeling, ethical design, social well-being, and workforce transformation.',
    subtopicsLabel: 'Subtopics:',
    subtopics: [
      'AI & Robotics for Renewable Energy Systems',
      'Disaster Response & Humanitarian Robotics',
  ...
  },
  {
    id: 7,
    title: '7️⃣ Demos, Competitions & Innovation Showcases',
    description: 'Interactive and competitive sessions including hackathons, model benchmarking, student competitions, startup pitches, and live robotics demonstrations.',
    subtopicsLabel: 'Subtopics:',
    subtopics: [
      'Robotics Hackathon & Design Challenge',
      'AI Model Benchmarking Session',
  ...
  },
  {
    id: 8,
    title: '8️⃣ Panel & Roundtable Topics',
    description: 'Discussion forums on AI and robotics ethics, regulation, commercialization, human-machine collaboration, and space exploration.',
    subtopicsLabel: 'Topics Include:',
    subtopics: [
      'The Future of Human–Machine Collaboration',
      'AI Regulation: Balancing Innovation and Safety',
      ...
      >
        <div className="px-5 sm:px-6 pb-6 pt-0">
          ...
          <Link
            ...
            className="inline-block text-white font-bold py-3 px-6 rounded-md transition-all duration-300"
            style={{ backgroundColor: themeColor, fontFamily: "'Manrope', sans-serif" }}
            onMouseOver={(e) => (e.currentTarget.style.backgroundColor = '#4967a0')}
            onMouseOut={(e) => (e.currentTarget.style.backgroundColor = themeColor)}
          >
            {track.buttonText}
          </Link>
