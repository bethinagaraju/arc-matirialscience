...
// // //           <p className="text-xl">Everything you need to know about attending PharmaTech 2026 in Rome</p>
// // //         </div>
// // //       </div>
...
// //                  We have negotiated special rates with several hotels near the venue. Mention "PharmaTech 2026" when booking.
// //                </p>
// //             </div>
...
//                     We recommend these hotels near the venue. Mention "PharmaTech 2026" for special rates.
//                   </p>
//                 </div>
//               </div>
    ...
    <section className="bg-white text-[#1F2327]">
      ...
      <div className="max-w-6xl mx-auto px-6 space-y-20">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          {/* Airport */}
          <div className="p-8 border border-[#E5E7EB] bg-[#F9FAFB]">
            <div className="flex gap-4">
              <Plane className="w-7 h-7 text-[#C9AB63]" />
              <div>
                <h3 className="text-xl font-semibold mb-3">Nearest Airport</h3>
                <p className="text-[#6B6F74] mb-4">
                  <strong>Rome Fiumicino Airport (FCO)</strong> — approx. 30 km from venue.
                </p>
                <ul className="space-y-3">
                  <TransportOption label="Taxi (Fixed Rate)" />
                  <TransportOption label="Leonardo Express" />
                  <TransportOption label="Bus Shuttle" />
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 border border-[#E5E7EB] bg-[#F9FAFB]">
            <div className="flex gap-4">
              <Car className="w-7 h-7 text-[#C9AB63]" />
              <div>
                <h3 className="text-xl font-semibold mb-3">Local Transport</h3>
                <p className="text-[#6B6F74] mb-4">
                  Rome offers efficient public transportation.
                </p>
                <ul className="space-y-3">
                  <TransportOption label="Metro / Bus Tickets" />
                  <TransportOption label="Roma Pass" />
                  <TransportOption label="Rideshare Services" />
                </ul>
              </div>
            </div>
          </div>
        ...
        {/* ================= VISA ================= */}
        <div className="border border-[#E5E7EB] p-10 bg-[#F9FAFB]">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="font-semibold mb-4">Visa Requirements</h3>
              <ul className="space-y-2 text-[#6B6F74]">
                {[
                  "Visa on arrival / Schengen visa (country dependent)",
                  "Valid passport (6+ months)",
                  "Return travel ticket",
                  "Accommodation proof"
                ].map((item, i) => (
                  <li key={i} className="flex gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#C9AB63]" />
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div>
              <h3 className="font-semibold mb-4">Conference Assistance</h3>
              <ul className="space-y-2 text-[#6B6F74]">
                <li className="flex gap-2">
                  <Mail className="w-4 h-4 text-[#C9AB63]" />
                  Invitation letters upon request
                </li>
                <li className="flex gap-2">
                  <Phone className="w-4 h-4 text-[#C9AB63]" />
          ...
          <div className="text-center mt-8">
            <button className="px-6 py-3 border border-[#C9AB63] text-[#1F2327] font-semibold hover:bg-[#C9AB63]/10 transition">
              Request Invitation Letter
            </button>
          </div>
        </div>
        ...
        <div>
          <div className="flex gap-4 mb-8">
            <Hotel className="w-7 h-7 text-[#C9AB63]" />
            <div>
              <h3 className="text-3xl font-bold">Hotel Suggestions</h3>
              <p className="text-[#6B6F74] mt-1">
                Mention “PharmaTech 2026” for conference rates.
              </p>
            </div>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <HotelCard name="Crowne Plaza Rome" stars={4} distance="On-site" />
            <HotelCard name="Hotel Degli Aranci" stars={4} distance="15 min walk" />
            <HotelCard name="Hotel Mozart" stars={3} distance="20 min by Metro" />
          </div>
        </div>
        ...
        <div>
          <div className="flex gap-4 mb-8">
            <Camera className="w-7 h-7 text-[#C9AB63]" />
            <div>
              <h3 className="text-3xl font-bold">Explore Rome</h3>
              <p className="text-[#6B6F74] mt-1">
                Iconic landmarks near the venue.
              </p>
            </div>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <AttractionCard name="Vatican City" location="0.8 km" />
            <AttractionCard name="Colosseum" location="4.5 km" />
            <AttractionCard name="Trevi Fountain" location="3.2 km" />
            <AttractionCard name="Spanish Steps" location="3.5 km" />
          </div>
        </div>

        <p className="text-center text-sm text-[#6B6F74] italic">
          Venue and travel information is provided for guidance only.
        </p>
...
function HotelCard({ name, stars, distance }) {
  return (
    <div className="border border-[#E5E7EB] p-6 hover:shadow-md transition">
      <h4 className="font-semibold text-lg mb-1">{name}</h4>
      <div className="flex text-[#C9AB63] mb-2">
        {[...Array(stars)].map((_, i) => (
          <Star key={i} className="w-4 h-4 fill-current" />
        ))}
      </div>
      <p className="text-sm text-[#6B6F74] flex items-center gap-1">
...
function AttractionCard({ name, location }) {
  return (
    <div className="border border-[#E5E7EB] p-4">
      <h4 className="font-semibold">{name}</h4>
      <p className="text-sm text-[#6B6F74] flex items-center gap-1">
        <MapPin className="w-3 h-3 text-[#C9AB63]" /> {location}
      </p>
    </div>
  );
}
...
function TransportOption({ label }) {
  return (
    <li className="flex justify-between border-b border-[#E5E7EB] pb-2 text-sm">
      <span className="text-[#6B6F74]">{label}</span>
    </li>
  );
}
