      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mt-3">
            Our dedicated team of experts brings together decades of experience in AI, ML, and robotics to ensure PharmaTech 2026 delivers unparalleled value and innovation.
          </p>
        </div>
