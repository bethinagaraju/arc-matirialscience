...
// //         <div className="container mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-8 mt-24">

// //           {/* LEFT CONTENT */}
// //           <div className="max-w-3xl w-full bg-white bg-opacity-40 backdrop-blur-sm py-6 sm:py-10 px-4 sm:px-8 text-center lg:text-left">
// //             {/* Title */}
// //             <p
// //               className="text-xl sm:text-3xl md:text-4xl font-semibold mb-4 sm:mb-6 text-black uppercase leading-snug"
// //               style={{ fontFamily: 'Manrope, sans-serif' }}
...
// //             {/* Date & Venue */}
// //             <p className="text-lg sm:text-xl md:text-2xl font-medium mb-6 text-gray-800">
// //               July 28–30, 2026 | Crowne Plaza – St. Peter's Rome, Italy
// //             </p>

// //             {/* Buttons */}
// //             <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-3 sm:gap-5 w-full">
// //               <Link to="/register">
// //                 <button
...
//       {/* Content Container */}
//       <div className="relative min-h-[430px] flex items-center justify-center px-4 sm:px-6 md:px-10">
//         <div className="container mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-2 lg:gap-2 pt-20 pb-10">

//           {/* LEFT CONTENT */}
//           <div className="max-w-3xl w-full bg-white bg-opacity-40 backdrop-blur-sm py-6 sm:py-8 px-4 sm:px-8 text-center lg:text-left">
//             <p
...
const HeroSection: React.FC = () => {
  return (
    <section className="relative bg-gradient-to-r from-teal-700 to-teal-600 text-white overflow-hidden">
      ...
      {/* Content Container */}
      <div className="relative min-h-[430px] flex items-center justify-center px-4 sm:px-6 md:px-10">
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-start gap-2 lg:gap-4 pt-20 pb-10">
